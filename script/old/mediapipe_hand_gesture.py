...
from src.hand_gesture.utils import CvFpsCalc
from src.hand_gesture.model import KeyPointClassifier
from src.hand_gesture.model import PointHistoryClassifier
...
from src.hand_gesture.utils.actions import action_for_sign, terminate_for_sign
...
def mediapipe_hand_gesture(alert_gesture):
    # Argument parsing
    args = get_args()
    ...
    # Read labels
    with open('src/hand_gesture/model/keypoint_classifier/keypoint_classifier_label.csv',
    ...
    with open(
            'src/hand_gesture/model/point_history_classifier/point_history_classifier_label.csv',
            encoding='utf-8-sig') as f:
...
def main():
    point_coords = mediapipe_hand_gesture(alert_gesture="pointer")
    # print(point_coords)
